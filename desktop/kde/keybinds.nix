...
in
{
  programs.plasma = {
    ...
    hotkeys.commands = moveFollowCommands // {
      # --- Albert ---
      "albert-toggle" = { name = "Albert Launcher"; key = "Meta+A"; command = "albert toggle"; };
      "albert-files" = { name = "Albert: busca de arquivos"; key = "Meta+Shift+A"; command = "${albertFiles}"; };
      "albert-power" = { name = "Albert: menu de energia"; key = "Meta+Ctrl+A"; command = "${albertPower}"; };

      # --- Kora (serviço web em :8787; abre no navegador padrão) ---
      "kora-ui" = { name = "Abrir Kora (UI)"; key = "Meta+I"; command = "xdg-open http://127.0.0.1:8787"; };
      "kora-chat" = { name = "Kora: chat rápido"; key = "Meta+Shift+I"; command = "xdg-open http://127.0.0.1:8787/chat"; };
      "kora-agents" = { name = "Kora: painel de agentes"; key = "Meta+Ctrl+I"; command = "xdg-open http://127.0.0.1:8787/agents"; };
      ...
      # --- Janelas / Apps ---
      "terminal" = { name = "Terminal"; key = "Meta+Return"; command = "kryonix-terminal"; };
      ...
      "terminal-float" = { name = "Terminal flutuante"; key = "Meta+Shift+Return"; command = "kryonix-terminal"; };
      "dolphin" = { name = "Dolphin"; key = "Meta+O"; command = "dolphin"; };
      "zen" = { name = "Zen Browser"; key = "Meta+N"; command = "flatpak run app.zen_browser.zen"; };
      "zen-new" = { name = "Zen Browser (nova janela)"; key = "Meta+Shift+N"; command = "flatpak run app.zen_browser.zen --new-window"; };
      "vscode" = { name = "VSCode"; key = "Meta+R"; command = "code-insiders"; };

      # --- Sessão: reiniciar com diálogo de confirmação ---
      "reboot" = { name = "Reiniciar sistema"; key = "Meta+Ctrl+Escape"; command = "qdbus6 org.kde.LogoutPrompt /LogoutPrompt promptReboot"; };

      # --- Mídia (playerctl) ---
      "media-prev" = { name = "Faixa anterior"; key = "Meta+,"; command = "playerctl previous"; };
      "media-next" = { name = "Próxima faixa"; key = "Meta+."; command = "playerctl next"; };
      "media-playpause" = { name = "Play/Pause"; key = "XF86AudioPlay"; command = "playerctl play-pause"; };
    };
