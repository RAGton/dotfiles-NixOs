...

{
  imports = [
    ...
    (lib.mkRemovedOptionModule
      [ "kryonix" "features" "remoteDesktop" "server" "enable" ]
    ...
    (lib.mkRemovedOptionModule
      [ "kryonix" "features" "ai" "brain" "enable" ]
    ...
    (lib.mkRemovedOptionModule
      [ "kryonix" "features" "gpu" "intel" "legacyVaapi" "enable" ]
