#!/usr/bin/env python3
"""Gera os assets raster do tema Plymouth autoral do NODE.
...
THEME_DIR = REPO_ROOT / "themes" / "plymouth" / "node"
...
def extract_logo() -> Image.Image:
    ...
    bbox = mask.getbbox()
    if not bbox:
        raise RuntimeError("Nao foi possivel extrair a marca do NODE.")
