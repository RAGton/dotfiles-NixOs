...

{
  ...
  services.displayManager.autoLogin.user = "ragos";
  ...
  environment.etc."xdg/openbox/autostart".source =
    "${ragosOpenboxAutostart}/bin/ragos-openbox-autostart";

  environment.etc."chromium/policies/managed/ragos-kiosk.json".text = builtins.toJSON {
  ...
  systemd.services.display-manager.wants = [ "ragos-live-paths.service" ];
  systemd.services.display-manager.after = [ "ragos-live-paths.service" ];
}
