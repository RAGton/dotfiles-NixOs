...
// Ajuste local: remover o hover vermelho hardcoded e alinhar os estados ao
// AccentColor do RAGOS.
//
            ...
            states: [
                State {
                    ...
                    PropertyChanges {
                        ...
                        palette.buttonText: Qt.darker(config.AccentColor, 1.15)
                    }
                    PropertyChanges {
                ...
                State {
                    ...
                    PropertyChanges {
                        target: parent.children[index]
                        palette.buttonText: Qt.lighter(config.AccentColor, 1.25)
                    }
                    PropertyChanges {
                        target: parent.children[index].background
                ...
                State {
                    ...
                    PropertyChanges {
                        target: parent.children[index]
                        palette.buttonText: config.AccentColor
                    }
                    PropertyChanges {
                        target: parent.children[index].background
