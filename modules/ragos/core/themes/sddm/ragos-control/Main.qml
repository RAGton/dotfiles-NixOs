...
Item {
    ...
    readonly property string displayHostName: (config.HostLabel && config.HostLabel !== "") ? config.HostLabel : ((sddm.hostName && sddm.hostName !== "") ? sddm.hostName : (config.FallbackHostName || "ragos-client"))
    ...
    Column {
        ...
        Text {
            text: config.HeaderText || "RAGOS Control"
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                ColumnLayout {
                    ...
                    Text {
                        text: "Greeter declarativo do cliente RAGOS"
                        color: root.secondaryText
                        font.family: "Noto Sans"
                        font.pointSize: 11
                    }
